...
class CheckinByCpfUseCase implements UseCase<CheckinByCpfUseCase.Input, CheckinByCpfUseCase.Output> {
    constructor(
        private readonly userRepository: UserRepository,
        private readonly accessService: AccessService,
    ) { }

    async execute(input: CheckinByCpfUseCase.Input): Promise<CheckinByCpfUseCase.Output> {
